...
class DicasController extends StandardController
{
    protected $model;
    protected $request;
    protected $View = 'painel.dicas';
    protected $redirectCad = '/painel/dicas/cadastrar';
    protected $redirectEdit = '/painel/dicas/editar';
    protected $route = '/painel/dicas';
    

    public function __construct(Dica $dica, Request $request)
    {
        $this->model = $dica;
    ...
    * */
    public function cadastrarGo()
    {
        ...
        //Define o caminho
        $path = public_path('assets/uploads/imgs/dicas');
