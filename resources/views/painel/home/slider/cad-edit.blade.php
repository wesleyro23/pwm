            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div id="morris-area-chart">
                        ...
                        @if( isset($data))
                            <form class="form" method="POST" action="/painel/slider/editar/{{ $data->id }}" enctype="multipart/form-data">
                        @else
                            <form class="form" method="POST" action="/painel/slider/cadastrar" enctype="multipart/form-data">
                        @endif
                                {{ csrf_field() }}
